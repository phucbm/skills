...
|-------|---------|--------------|
| `setup` | `/wp-acf-blocks:setup` | Set up new theme — copies boilerplate, replaces placeholders, installs mu-plugins |
...
- 3 mu-plugins bundled in `boilerplate/mu-plugins/` (installed by `/wp-acf-blocks:setup`)
